...
function buildPrompt(
  ...
  return [
    ...
    '- Those two rules FLIP for an account marked (debt), where the balance is what is owed:',
    '  money going toward it pays it down and is "make"; a new charge on it is "spend".',
    '  "Paid 20 on my bike loan" is {"type":"make"} against that debt account, not a spend.',
